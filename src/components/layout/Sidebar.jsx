...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-60 bg-white dark:bg-dark-surface border-r border-gray-200 dark:border-dark-border p-4 gap-2 shrink-0">
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors duration-150 ${
                isActive
                  ...
                  : 'text-gray-500 dark:text-slate-400 hover:text-gray-900 dark:hover:text-slate-100 hover:bg-gray-100 dark:hover:bg-dark-muted'
              }`
            }
          >
            <Icon size={18} />
      ...
      <div className="border-t border-gray-200 dark:border-dark-border pt-3 mt-1 space-y-1">
        {/* Theme toggle */}
        <button
          onClick={toggleTheme}
          className="flex items-center gap-3 px-3 py-2.5 w-full rounded-xl text-sm font-medium text-gray-500 dark:text-slate-400 hover:text-gray-900 dark:hover:text-slate-100 hover:bg-gray-100 dark:hover:bg-dark-muted transition-colors duration-150"
        >
